...
//******************************************************************************
        ...
        SetWindowTextA(window::getHwnd(), oss.str().c_str());   
...
#endif
    //TODO_03 画面をクリアする
    GameLib::clear(0.4784f, 0.6705f, 0.6588f);
...
//******************************************************************************
    ...
    //TODO_04 文字の描画
    text_out(2, "Hello World", 100, 0,2.0f ,1.0f,1.0,0);   // 見本
...
//******************************************************************************
    ...
    //TODO_06 基本図形（プリミティブ）
    //1. primitive::line
    primitive::line(0, 0, 640, 360, 1, 0, 0);


        //2. primitive::rect
        primitive::rect(100, 100, 300, 200, 0, 0, ToRadian(-30), 1, 1, 1);

//3. primitive::circle
    primitive::circle(250, 200, 60, 1, 1, ToRadian(45), 1, 0, 0);
...
//******************************************************************************
    ...
    //3. 木のスプライトを描画する;
sprite_render(sprPink, 200, 200);
sprite_render(sprPink, 300, 200);
sprite_render(sprPink, 400, 200);
sprite_render(sprPink, 500, 200);
sprite_render(sprPink, 600, 200);
sprite_render(sprPink, 700, 200);
sprite_render(sprPink, 800, 200);
sprite_render(sprPink, 900, 200);
sprite_render(sprRed, 200, 300);
sprite_render(sprRed, 300, 300);
sprite_render(sprRed, 400, 300);
sprite_render(sprRed, 500, 300);
sprite_render(sprRed, 600, 300);
sprite_render(sprRed, 700, 300);
sprite_render(sprRed, 800, 300);
sprite_render(sprRed, 900, 300);
sprite_render(sprGreen, 200, 400);
sprite_render(sprGreen, 300, 400);
sprite_render(sprGreen, 400, 400);
sprite_render(sprGreen, 500, 400);
sprite_render(sprGreen, 600, 400);
sprite_render(sprGreen, 700, 400);
sprite_render(sprGreen, 800, 400);
sprite_render(sprGreen, 900, 400);
